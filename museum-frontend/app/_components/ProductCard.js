...
const ProductCard = ({ product, onAddToCart, onAddToFavorites, favoriteProducts }) => {
      ...
      <div className="product-card">
        <div className="product-img">
          ...
          <div className="img-overlay">
            <Link href={`/products/${id}`} className="more-btn">顯示更多</Link>
          </div>
        </div>
        ...
        <div className="product-status">
          <i className="fa-solid fa-box me-2"></i>{status}
        </div>
        <div className="product-actions">
          <AddToCartButton productId={id} onAddToCart={onAddToCart} disabled={isOutOfStock} />
